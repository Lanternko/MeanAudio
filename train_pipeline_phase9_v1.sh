...
#   Q signal 完全移除（null token）→ 控制組
#   對照：Phase 9 V2（same + Q=pairwise MeanSim）
#
# NPZ：~/phase9_multicap_npz/（SSD，251,599 clips，shape: [5,77,1024]/[5,512]）
# TSV：phase7_v1_train.tsv（同一批 251,599 clips）
#
# 使用方式：
#   tmux new -s phase9_v1
#   cd ~/MeanAudio && source ~/venvs/dac/bin/activate
#   bash train_pipeline_phase9_v1.sh
# ============================================================
...
USE_Q_CONDITIONING=false          # V1：no Q
...
echo "======================================================"
echo "  Phase 9 V1 — TrueRandom, No Q"
