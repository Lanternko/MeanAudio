...
EMA="$WORK_DIR/exps/mfexpanded3cap100k_noq_stage2_100000/mfexpanded3cap100k_noq_stage2_100000_ema_final.pth"
SHORTDIRECT_TSV="$DATA_DIR/music_flamingo_slice10_100k_short_direct_mfcap_jamendo_holdout2048.tsv"
EXP_NAME="mfexpanded3cap100k_noq_stage2_100000_jamendo_holdout2048_shortdirect_mfcap"
...
echo "======================================================"
echo "  Eval-only: MF-expanded-3cap 100k on short-direct MF Jamendo prompts"
echo "  EMA    : $EMA"
