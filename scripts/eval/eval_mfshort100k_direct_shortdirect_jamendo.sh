...
CAPTION_OUT="$HOME/eval_output/music_flamingo_slice10_100k_short_direct_mfcap_jamendo_holdout2048"
SHORTDIRECT_TSV="$DATA_DIR/music_flamingo_slice10_100k_short_direct_mfcap_jamendo_holdout2048.tsv"
EXP_NAME="mfshort100k_direct_noq_stage2_100000_jamendo_holdout2048_shortdirect_mfcap"
...
echo "======================================================"
echo "  Eval-only: MF-short-direct 100k on short-direct MF Jamendo prompts"
echo "  EMA       : $EMA"
...
if [ "$caption_count" -lt 2048 ]; then
    N=2048 \
    OUT_DIR="$CAPTION_OUT" \
    LOG="$LOG_DIR/music_flamingo_slice10_100k_short_direct_mfcap_jamendo_holdout2048_caption.log" \
    TSV="$SOURCE_HOLDOUT_TSV" \
    LPMC_TSV="$SOURCE_HOLDOUT_TSV" \
    PROMPT_PRESET="short_direct_v1" \
    PROMPT_VERSION="slice10_short_direct_v1_holdout2048" \
