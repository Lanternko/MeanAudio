#!/usr/bin/env python3
"""063 P2 guest: eval-only supervisor for the absolute-level gain ladder.
...
def progress(c):
    ...
    return (len(list((root / 'items').glob('*/*.json'))),
    ...
    try:
        while True:
            ...
            if request:
                ...
                atomic_json(resume, {'document_kind': 'gain_ladder_resume_v1',
