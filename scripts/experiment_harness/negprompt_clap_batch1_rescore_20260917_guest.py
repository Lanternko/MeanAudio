#!/usr/bin/env python3
"""062 P2 guest: eval-only supervisor for the batch-1 CLAP rescore of the negprompt tables.
...
def progress(c):
    ...
    return (len(list(root.glob('cfg*/*.json'))),
            len(list((root / '_audio').glob('*/*/*.flac'))))
    ...
    try:
        while True:
            ...
            if request:
                ...
                atomic_json(resume, {'document_kind': 'negprompt_clap_batch1_rescore_resume_v1',
