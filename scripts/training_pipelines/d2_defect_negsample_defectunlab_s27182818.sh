#!/bin/bash
# 075 seed replicate: defectunlab, training seed 27182818 (recipe identical to s14159265 except seed).
# Prereg addendum: docs/experiments/d2_defect_negsample_075_seed_replicates_20260924.md
set -eo pipefail
export D2_SEED=27182818
bash "$HOME/MeanAudio/scripts/training_pipelines/d2_defect_negsample_action.sh" defectunlab
...
E=phase8_qwen_caption2p0_slot0clean_defectunlab_noq_quarter_s27182818_stage1_100000
