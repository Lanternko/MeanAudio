#!/bin/bash
# 075 seed replicate: defectunlab, training seed 16180339 (recipe identical to s14159265 except seed).
...
E=phase8_qwen_caption2p0_slot0clean_defectunlab_noq_quarter_s16180339_stage1_100000
