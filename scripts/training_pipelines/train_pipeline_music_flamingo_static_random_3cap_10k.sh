...
ORIGINAL_PREFIX="music_flamingo_slice10_10k"
DIRECT_PREFIX="music_flamingo_slice10_10k_short_direct"
AESTHETIC_PREFIX="music_flamingo_slice10_10k_short_aesthetic"
STATIC_PREFIX="music_flamingo_slice10_10k_static_random_3cap"
...
if [ "$caption_count" -lt 10000 ]; then
    N=10000 \
...
EXP_PREFIX="${EXP_PREFIX:-mfstatic3cap10k_noq_fast}" \
EXPECTED_N=10000 \
