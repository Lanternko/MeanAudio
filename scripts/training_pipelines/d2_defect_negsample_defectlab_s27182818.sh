#!/bin/bash
# 075 seed replicate: defectlab, training seed 27182818 (recipe identical to s14159265 except seed).
...
E=phase8_qwen_caption2p0_slot0clean_defectlab_noq_quarter_s27182818_stage1_100000
