...
> ⛔ **2026-07-16 correctness correction**：本設計使用的 P9/P9.5
> multi-caption caches 均由 positional writer 產生，audio–caption pairing
> 錯配。以下保留為歷史 design record；所有既有結果與 multi-cap claim
> 失效，需以 canonical gt_cache + v2 manifest cache 從零重跑。
...
**這是 2026-04-18 york135 澄清的重要事實**（見 `docs/meetings/2026-04-18_lane_abc_and_lpmc.md`）：
