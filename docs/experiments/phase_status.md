...
| arm | CFG0 CLAP | CE | CU | PC | PQ | CFG3+neg CLAP 逐檔 | **CLAP b32** | CE | CU | PC | PQ |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 013 true random NoQ quarter | 0.2013 | 6.2505 | 6.7838 | 4.9690 | 6.6079 | 0.2290 | **0.2406** | 7.0443 | 7.6387 | 4.9165 | 7.4901 |
| qk3b quarter q9 | 0.1898 | 6.3433 | 6.7093 | 5.1366 | 6.6042 | 0.2167 | **0.2267** | 7.0397 | 7.5069 | 4.9005 | 7.3956 |
| qk3b quarter q0 | 0.1843 | 6.1299 | 6.5605 | 5.0969 | 6.4657 | 0.2162 | **0.2254** | 7.0078 | 7.4763 | 4.8879 | 7.3503 |
| qk10b quarter q9 | 0.1937 | 6.1677 | 6.7452 | 5.0382 | 6.4805 | 0.2167 | **0.2312** | 7.1172 | 7.5811 | 4.9964 | 7.4022 |
| qk10b quarter q0 | 0.1893 | 5.9583 | 6.6537 | 5.0304 | 6.4088 | 0.2164 | **0.2299** | 7.0532 | 7.5541 | 5.0162 | 7.3761 |
| slot3 full | 0.2194 | 6.1976 | 6.7172 | 5.0576 | 6.5189 | 0.2470 | **0.2652** | 7.0849 | 7.5473 | 4.9945 | 7.4914 |
| slot1 quarter | 0.2047 | 6.3008 | 6.7593 | 5.1632 | 6.5668 | 0.2272 | **0.2477** | 6.8245 | 7.4758 | 5.0602 | 7.3096 |
| slot2 quarter | 0.2017 | 6.2071 | 6.7487 | 5.0814 | 6.5623 | 0.2252 | **0.2331** | 6.7102 | 7.4636 | 4.7721 | 7.2242 |
| 012 bestof3 quarter | 0.2129 | 6.2368 | 6.7327 | 5.1212 | 6.5316 | 0.2398 | **0.2554** | 7.0063 | 7.6436 | 4.9707 | 7.5605 |
| 012 worstof3 quarter | 0.1957 | 6.4072 | 6.8399 | 5.3208 | 6.6398 | 0.2158 | **0.2257** | 6.7602 | 7.5438 | 4.6943 | 7.4284 |
| fair013 bestof3 quarter | 0.2114 | 6.2046 | 6.6693 | 5.1490 | 6.4793 | 0.2382 | **0.2565** | 7.0030 | 7.5874 | 4.9713 | 7.5035 |
| fair013 worstof3 quarter | 0.1985 | 6.4061 | 6.8835 | 5.2172 | 6.6789 | 0.2217 | **0.2402** | 6.9806 | 7.5684 | 4.9342 | 7.4429 |
| 013 fake random quarter | 0.2005 | 6.2253 | 6.7695 | 5.0934 | 6.5754 | 0.2268 | **0.2408** | 7.0048 | 7.6177 | 4.9498 | 7.4868 |
| fair013 q3 quarter (q9) | 0.1966 | 5.9310 | 6.4984 | 5.2635 | 6.3988 | 0.2154 | **0.2252** | 7.0286 | 7.5454 | 4.8688 | 7.3899 |
| qwen3cap q3 quarter (q9) | 0.1894 | 5.7757 | 6.4003 | 5.0264 | 6.2127 | 0.2146 | **0.2400** | 6.9220 | 7.3425 | 5.1518 | 7.1426 |
| modular_template quarter | 0.1865 | 6.5799 | 7.0477 | 5.3965 | 6.8294 | 0.2152 | **0.2287** | 7.1946 | 7.6892 | 5.2660 | 7.4811 |

**⚠️ 2026-09-14：CFG3+neg 的 CLAP 有兩把尺。** 上表「逐檔」來自 `phase4_eval.py`；negprompt_reeval 系列
（slot0 full 0.2605、slot2 full 0.2459、013 true/fake full 0.2651/0.2647 等）是 **batch 32**。laion_clap 在
batch > 8 時 padding 不同，同一份音檔 b32 − 逐檔 = **+0.0044～+0.0254，因 arm 而異**（AES 逐位相同）。
`scripts/eval/rescore_clap_batch32.py` 已把 eval_output_nvme 下 28 個留有音檔的 CFG3+neg 目錄重算（各目錄
`clap_batch32.json`；在 013 full 上逐位重現 0.2651）。CFG3+neg seed floor 0.0003 是在 b32 下量的，所以
**跨 arm 的 CFG3+neg CLAP 比較以 b32 為準**；但 scorer 間的 arm 相依偏移（中位數 ~0.013）比 floor 大 40 倍，
**只有兩把尺同號且都超出 2× floor 的 CLAP 差才寫成結論**。

先前已有 CFG3+neg 的 quarter 參照（b32 / 逐檔）：slot0 0.2372 / 0.2248（PQ 7.3101）、012 true random 0.2450 / 0.2337（PQ 7.4207）。
full 參照（b32）：slot0 0.2605、013 true random 0.2651。
CFG3+neg seed floor：CLAP 0.0003 / CE 0.2960 / CU 0.1053 / PC 0.1884 / PQ 0.1416（在 full 尺度量的；quarter 借用，判讀帶取 2×）。

觀察層（未另立 contract，只報數字與方向）：

1. **Q 線（048/049）**：q9−q0 CLAP 逐檔 +0.0005 / +0.0003、b32 +0.0013 / +0.0013 —— 都遠小於 scorer 偏移，
   不能宣稱有 Q-response。q9 vs NoQ 兩把尺都為負（逐檔 −0.0123 / −0.0123，b32 −0.0139 / −0.0094）→ **Q 傷 CLAP 穩健**。
   K=10 vs K=3 的 q9：逐檔 0.0000、b32 +0.0045 → scorer 間不一致，**不能排名**。細節見 `c2p0_truerandom_q_granularity_line.md`。
2. **best/worst-of-3**：CLAP best 勝 worst 兩把尺都成立（b32 012 +0.0297、fair013 +0.0163）。PQ：CFG0 下 worst 較高
   （012 +0.108、fair013 +0.200，超出 2× floor）；CFG3+neg 下 best 較高（012 +0.132、fair013 +0.061）但在 2× floor（0.283）內 ——
   只能寫成「CFG0 的 worst PQ 優勢在 negprompt 協定下消失」。
3. **quarter 單槽 vs rotation：scorer 相依，不寫結論。** 逐檔下 slot0/1/2（0.2248 / 0.2272 / 0.2252）全低於
   012 rotation 0.2337、013 true 0.2290 / fake 0.2268；b32 下 slot1 0.2477 **高於**所有 rotation（0.2450 / 0.2406 / 0.2408），
   slot0 0.2372、slot2 0.2331 則低於。
4. **true vs fake random quarter**：逐檔 +0.0022、b32 −0.0002，四項 AES 全在 2× floor 內 → 分不出來，與 K=3 rotation 收線一致。
5. **slot3 full**：b32 0.2652，高於 slot0 full 0.2605（+0.0047），與 013 rotation 0.2651 同值。
   ~~逐檔 0.2470「低於 slot0 0.2605 與 013 0.2515」~~ 前半是混 scorer 比較，撤回。
6. **modular_template quarter**：CFG0 CLAP 墊底（0.1865）；CFG3+neg b32 0.2287 仍在下半段；CE/CU/PC 仍是全表最高。
7. **scorer 偏移可以翻排名**：fair013 q3 vs qwen3cap q3（皆 q9）逐檔 0.2154 vs 0.2146（fair013 高），
   b32 0.2252 vs 0.2400（qwen3cap 高 0.0148）。qwen3cap 的偏移 +0.0254 是全表最大。
